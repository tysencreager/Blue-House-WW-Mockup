  ...
  return (
    <section id="about" className="section bg-cream">
      <div className="container-narrow grid lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-7 space-y-5 text-ink/80 text-lg leading-relaxed">
      ...
      <div className="container-narrow mt-16 grid sm:grid-cols-3 gap-6">
        {about.highlights.map((h) => (
          <div
            key={h.label}
            className="rounded-2xl border border-sand bg-white p-6 shadow-sm hover:shadow-soft transition-shadow"
          >
            <div
              aria-hidden="true"
              className="w-10 h-10 rounded-lg bg-ocean/10 text-ocean flex items-center justify-center mb-4"
            >
