...
export const galleryItems = [
  { id: 1, title: 'Live-Edge Walnut Dining Table',     category: 'Furniture',  src: null, alt: 'Live-edge walnut dining table with steel hairpin legs', aspect: 'landscape' },
  { id: 2, title: 'Floor-to-Ceiling Library Built-In', category: 'Built-Ins',  src: null, alt: 'White oak library built-in with rolling ladder', aspect: 'portrait' },
  { id: 3, title: 'Shaker-Style Kitchen',              category: 'Cabinetry',  src: null, alt: 'Shaker-style painted kitchen with butcher block island', aspect: 'landscape' },
  { id: 4, title: 'Reclaimed Oak Console',             category: 'Furniture',  src: null, alt: 'Reclaimed oak entryway console with iron hardware', aspect: 'landscape' },
  { id: 5, title: 'Mudroom Lockers',                   category: 'Built-Ins',  src: null, alt: 'Custom mudroom lockers with bench seating and cubbies', aspect: 'portrait' },
  { id: 6, title: 'Walnut Bath Vanity',                category: 'Cabinetry',  src: null, alt: 'Floating walnut bathroom vanity with vessel sinks', aspect: 'landscape' },
  { id: 7, title: 'Farmhouse Bench',                   category: 'Furniture',  src: null, alt: 'Reclaimed pine farmhouse dining bench', aspect: 'landscape' },
  { id: 8, title: 'Office Wall Unit',                  category: 'Built-Ins',  src: null, alt: 'Home office wall unit with integrated desk and shelving', aspect: 'portrait' },
  { id: 9, title: 'Custom Pantry',                     category: 'Cabinetry',  src: null, alt: 'Walk-in pantry with painted cabinets and butcher block counters', aspect: 'landscape' },
]
